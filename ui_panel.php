...
countdown( "countdown", 15, 0 );
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"><a href="ui_panel.php"> <i class="fa fa-window-restore"></i> UI Panel </a></li>
      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom"> UI Panel </h2>
          </div>
        </div>
       ...
       <div class="title"><strong class="d-block"> Remote Connect <i class="fa fa-plug"></i> </strong>
                  <span class="d-block"> Remote connect to your UI Panel </span></div>

                  <div class="block-body">
                    <form action="" method="post">
                      <div class="form-group">
                        <label class="form-control-label"> Device IP </label>
                        <input type="text" name="ui_ip" class="form-control" placeholder="Device IP" pattern="^([0-9]{1,3}\.){3}[0-9]{1,3}$" required>
                      </div>
                      <div class="form-group">       
                  <button type="submit" name="submit_ui" class="btn btn-primary btn-block">
  ...
  <!-- Connection Form-->
      ...
      <div class="title"><strong class="d-block"> Remote Logout <i class="fa fa-sign-out"></i> </strong>
                  <span class="d-block"> Remote logout from your UI Panel </span></div>

                  <div class="block-body">
                    <form action="" method="post">
                      <div class="form-group">
                        <label class="form-control-label"> Device IP </label>
                        <input type="text" name="ui_ip_logout" class="form-control" placeholder="Device IP" pattern="^([0-9]{1,3}\.){3}[0-9]{1,3}$" required>
                      </div>
                      <div class="form-group">       
             <button type="submit" name="submit_ui_logout" class="btn btn-primary btn-block"> 
               Request &nbsp; <i class="fa fa-paper-plane"></i> 
             </button>
                      </div>
                    </form>
...
function input($data)
   ...
   if (isset($_POST['submit_ui']))
       {

      $device_ip = input($_POST['ui_ip']);
...
// remote ui panel logout       
   ...
   if (isset($_POST['submit_ui_logout']))
      ...
      $device_ip = input($_POST['ui_ip_logout']);
