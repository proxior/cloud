...
countdown( "countdown", 15, 0 );
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"><a href="router.php"> <i class="fa fa-fax"></i> Router </a></li>
      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom"> Router Management </h2>
          </div>
        </div>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
           ...
           <div class="title"><strong class="d-block"> Remote Connect <i class="fa fa-plug"></i> </strong>
                  <span class="d-block"> Remote connect to your router </span></div>

                  <div class="block-body">
                    <form action="" method="post">
                      <div class="form-group">
                        <label class="form-control-label"> Router Public Gateway </label>
          <input type="text" name="rout_ip" class="form-control" placeholder="Router Public Gateway" pattern="^([0-9]{1,3}\.){3}[0-9]{1,3}$" required>
                      </div>
                      <div class="form-group">       
                       <button type="submit" name="submit_rout" class="btn btn-primary btn-block">
  ...
  <!-- Connection Form-->
       ...
       <div class="title"><strong class="d-block"> Remote Logout <i class="fa fa-sign-out"></i> </strong>
                  <span class="d-block"> Remote logout from your router </span></div>
            ...
            <input type="text" name="rout_ip" class="form-control" placeholder="Router Public Gateway" pattern="^([0-9]{1,3}\.){3}[0-9]{1,3}$" required>
                      ...
                      <div class="form-group">       
                        <button type="submit" name="submit_rout_logout" class="btn btn-primary btn-block">
                          Request &nbsp; <i class="fa fa-paper-plane"></i>
                        </button>
                      </div>
                    </form>
...
function input($data)
   ...
   if (isset($_POST['submit_rout']))
     {

      $device_ip = input($_POST['rout_ip']);
